...
SIGNED_KEY = $(LIB_MCUBOOT_DIR)/root-rsa-2048.pem
SIGN = $(LIB_MCUBOOT_SCRIPT_DIR)/imgtool.py
SIGN_OPT = sign --key $(SIGNED_KEY) --header-size $(HEADER_SIZE) --align $(FLASH_ALIGN) --version 1.2 -S $(SLOT_SIZE) $(APPL_FULL_NAME).bin $(SIGNED_IMAGE).bin

# compile options only valid in this library
LIB_MCUBOOT_DEFINES += -DLIB_MCUBOOT -DMCUBOOT_SIGN_RSA -DMCUBOOT_VALIDATE_SLOT0 -DMCUBOOT_USE_FLASH_AREA_GET_SECTORS -DMBEDTLS_CONFIG_FILE=\"config-boot.h\"
